...
def getLabel(id):
    return ['ANGRY','CONTEMPT','DISGUST','FEAR','HAPPY','SAD','SURPRISE'][id]

model = load_model('C:\\Users\\S MITRA\\Documents\\Sujan\\PythonProjects\\Facial Expression Recognizer\\SavedModels\\fecMine.h5')
...
for (x, y, a, a) in faces:
    ...
    test_image = np.array(resized_img).reshape(1, 128, 128, 3)
